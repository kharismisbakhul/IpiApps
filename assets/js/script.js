...
let iniUrl = 'http://localhost/IpiApps/Admin/getIpi?' + data[1];
var nama_dimensi = [];
var tahun = [];
var nilaiIpi = [];
var nilaiDimenasi = [];
...
$(document).ready(function () {
    $.ajax({
        ...
        error: function (data) {
            $('#ipi-chart').remove();
            $('.chart').append('<img src="http://localhost/IpiApps/assets/img/error_data.png" width="60%" alt="no data" class="rounded mx-auto d-block">')
        }
    });
})
