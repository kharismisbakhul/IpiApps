...
$(document).ready(function () {
	$.ajax({
		...
		beforeSend: function (data) {
			$("#chart-dimensi").hide();
			$(".chart").append(
				'<img src="http://localhost/IpiApps/assets/img/loader.gif" alt="no data" class="rounded mx-auto d-block loader">'
			);
		},
		...
		error: function (data) {
			...
			$(".chart").append(
				`<img src="http://localhost/IpiApps/assets/img/no_data.png" class="rounded mx-auto d-block" alt="no data" style="width: 50%; margin-top: -100px;">`
			);
		}
	});
});
